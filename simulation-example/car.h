...
#ifndef SIMULATION_EXAMPLE_CAR_H
#define SIMULATION_EXAMPLE_CAR_H
...
class Car {
    ...
    int mileage;
public:
    Car(std::string registration_nr, std::string model, std::string color, int mileage) :
            registration_nr{std::move(registration_nr)},
...
#endif //SIMULATION_EXAMPLE_CAR_H
